...
contract MinimumPerps is ERC4626, Ownable2Step {
    ...
    uint256 public constant MAX_BORROWING_RATE = 3170979198376458650431;
    ...
    function increasePosition(
        ...
        Position memory position = positions[increaseFor];
        ...
        positions[increaseFor] = position;
        ...
        if (isPositionLiquidatable(increaseFor, isLong))
    ...
    function decreasePosition(
        ...
        if (isPositionLiquidatable(owner, isLong))
            revert Errors.PositionIsLiquidatable();
    }
    ...
    function _validateMaxUtilization() internal {
        ...
        uint256 reservedForLongs = openInterestLong;
