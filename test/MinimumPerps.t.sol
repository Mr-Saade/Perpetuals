...
contract MinimumPerpsTest is Test {
    ...
    function setUp() public {
        ...
        // Borrowing fees deactivated by default
    }
    ...
    function test_increase() public {
        ...
        MinimumPerps.Position memory bobPosition = minimumPerps.getPosition(
            true,
            bob
        );
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                Errors.MaxUtilizationBreached.selector,
                50 * 1e30,
                100 * 1e30
            )
        );
    ...
    function test_borrowingFees() public {
        ...
        uint256 pendingBorrowing = minimumPerps.getPendingBorrowingFees(
            bob,
            true
        );
        ...
        assertEq(
            bobUsdcBalAfter - bobUsdcBalBefore,
            40e6 + 1 - (11e6 - 1) - 210958
        );
        ...
        uint256 liquidityPoolWithBorrowingFees = 300e6 +
            10e6 -
            1 +
            11e6 -
            1 +
        ...
        assertEq(
            aliceUsdcBalAfter - aliceUsdcBalBefore,
            liquidityPoolWithBorrowingFees - 1
        );
    }
}
